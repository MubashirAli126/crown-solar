                ...
                <div className="m-auto p-8 md:px-40 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row justify-between lg:text-left" data-aos="zoom-out">
                        <div className=" flex flex-col justify-center">
                            <video className="rounded-lg" src={(require('../../public/videos/solaranimated.mp4'))} autoPlay loop muted />
                            {/* <video className="rounded-lg" autoPlay loop muted>
                                <source className="h-0" src="images/videos/solaranimated.mp4" type="video/mp4" />
                            </video> */}
                        </div>
                        <div className="lg:w-4/5 flex flex-col justify-center">
                            ...
                            <h3 className="text-xl mt-4 ml-4 text-black font-medium">Long life performance certified  <br />
                                <span className='text-2xl font-semibold text-green-700'>Certified with quality checks and international standards</span></h3>
                            <div>
