...
import image1 from '../../public/images/JapaneseTechnologySection.png';

function TrustBanner() {
    return (
        <>
            <div className="m-auto p-4 max-w-xl sm:max-w-2xl md:max-w-4xl lg:max-w-5xl xl:max-w-7xl h-5/6">
                    ...
                    <div className="justify-center self-center" data-aos="fade-left">
                        ...
                        <div>
                            <p className='my-3 text-base text-black font-medium'>
                                Harnessing the power of Japanese innovation, our solar panels stand as a testament to quality and performance. The Crown 560W & 580W solar panels are designed to deliver exceptional efficiency, making them an ideal choice for those who prioritize both sustainability and reliability. The JPEA certification further reinforces our commitment to meeting the highest industry standards,
                                providing you with solar panels that not only meet but exceed expectations.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* <section>
                <div className="m-auto p-8 max-w-screen-xl max-w-screen-lg max-w-screen-sm md:px-4 h-5/6">
            ...
            {/* <h3 className="lg:text-xl text-lg mt-4 ml-4 text-black font-medium">Long life performance certified <br />
                                <span className='lg:text-2xl text-xl font-semibold text-green-700'>Certified with quality checks and international standards</span></h3>
                            <div>
                                <p className='my-3 ml-4 text-base text-black font-medium'>
