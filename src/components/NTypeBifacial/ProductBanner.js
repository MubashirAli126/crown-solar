...
import image1 from '../../../public/images/solar/ProductNTypeBifacial.png';

function ProductBanner() {
    return (
        <>
            <div
                className="relative overflow-hidden bg-cover bg-no-repeat h-[600px]">
                <Image className='nTypeBiBanner w-full' alt="card img" src={image1} />
            </div>
