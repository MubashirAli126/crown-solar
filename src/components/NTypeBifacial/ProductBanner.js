...
function ProductBanner() {
    return (
        <>
            <div
                className="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] h-[600px] nTypeBiBanner">
            </div>
            <div className="w-100 mx-auto px-6 sm:max-w-2xl md:max-w-3xl md:px-8 lg:max-w-5xl xl:max-w-7xl xl:px-32">
                <div className="text-center">
                    <div
                        className="block rounded-lg px-6 py-12 bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] md:py-8 md:px-8 mt-[-70px] backdrop-blur-[30px]">
