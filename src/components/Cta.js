...
const Cta = () => {
    return ( 
        <div className="w-full flex items-center justify-center text-white bannerAdd">
            <div className="w-full text-center lg:text-left py-12 md:px-40 lg:px-40 px-3 flex lg:justify-between items-center">                    
                <div className="w-full flex flex-col lg:flex-row lg:justify-around">
                    <div>
                        {/* <p className='text-2xl md:text-base font-semibold mb-4'>Sleek Design Durability and sleek attributes makes Monocrystalline Panels worth the pruchase You can enjoy the benefits of solar energy for a long time <br /> with our sleek and sturdy solar panels. They are designed to fit neatly on your roof and blend in with your homes appearance.</p>
                        <p className="text-lg md:text-text-base mb-4">Assemble Create your ideal home aesthetic with custom solutions</p> */}
                        <p className="lg:w-2/3 md:w-2/3 text-base font-medium md:text-text-base p-1.5">With Solar Roof, you can power your home with a solar and energy storage system that is fully integrated and looks great from any angle. <br /> The roof tiles are made of glass and steel, which are durable, strong and weather-resistant. You can schedule a virtual consultation with an expert to learn more about this innovative solution.</p>
                    </div>
                    
                    <div className="w-full lg:w-1/3 pt-6 lg:mx-12">
                        <Link href="/energy-calculator" className="bg-transparent border hover:bg-green-700 hover:border-green-800 text-white justify-center text-center rounded-lg px-10 py-3 flex items-center group">Energy calculator
