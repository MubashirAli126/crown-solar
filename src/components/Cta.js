            ...
            <div className="w-full text-center lg:text-left py-12 md:px-40 lg:px-40 px-3 flex lg:justify-between items-center">                    
                <div className="w-full flex flex-col lg:flex-row lg:justify-around">
                    <div>
                        ...
                        <p className="lg:w-11/12 md:w-11/12 text-base md:text-text-base p-1.5">With Solar Roof, you can power your home with a solar and energy storage system that is fully integrated and looks great from any angle. <br /> The roof tiles are made of glass and steel, which are durable, strong and weather-resistant. You can schedule a virtual consultation with an expert to learn more about this innovative solution.</p>
                    </div>
                    
                    <div className="w-full lg:w-72 pt-6 lg:mx-12">
                        <Link href="/energy-calculator" className="bg-transparent border hover:bg-blue-900 hover:border-blue-800 text-white justify-center text-center rounded-lg px-10 py-3 flex items-center group">Energy calculator
