            ...
            <div className="w-full text-center lg:text-left py-12 md:px-40 lg:px-40 px-3 flex lg:justify-between items-center">                    
                <div className="w-full flex flex-col lg:flex-row lg:justify-around">
                    ...
                    <div className="w-full lg:w-1/3 pt-6 lg:mx-12">
                        <Link href="/contact" className="bg-transparent border hover:bg-green-700 hover:border-green-800 text-white justify-center text-center rounded-lg px-10 py-3 flex items-center group">Become a Distributors 
